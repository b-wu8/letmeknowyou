...
if __name__ == "__main__":
    ...
    print(np.unique(age_train))
    print(np.unique(age_val))
    ...
    #                     epochs=epochs,callbacks=[tensorboard, early_stopping,checkpoint_period,reduce_lr])
